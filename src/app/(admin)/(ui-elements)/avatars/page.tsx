...
export const metadata: Metadata = {
  title: "Next.js Avatars | Duty Waiver - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Duty Waiver - Next.js Tailwind CSS Admin Dashboard Template",
};
