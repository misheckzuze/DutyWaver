...
export const metadata: Metadata = {
  title: "Next.js Buttons | Duty Waiver - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Duty Waiver - Next.js Tailwind CSS Admin Dashboard Template",
};
